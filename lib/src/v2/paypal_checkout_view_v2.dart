...
class PaypalCheckoutViewV2 extends StatefulWidget {
  ...
  final PayPalGetApprovalUrlV2? approvalUrl;
  ...
  final PayPalOrderRequestV2 transactions;
  ...
  State<StatefulWidget> createState() {
    return PaypalCheckoutViewV2State();
  }
}

class PaypalCheckoutViewV2State extends State<PaypalCheckoutViewV2> {
  PaypalPaymentModelV2? paymentModel;
  String navUrl = '';
  bool loading = true;
  bool pageloading = true;
  bool loadingError = false;
  late PaypalServicesV2 services;
  int pressed = 0;
  double progress = 0;
  final String returnURL = 'paypal-sdk://success';
  final String cancelURL = 'paypal-sdk://cancel';
  ...
  Future<void> initializePayment() async {
    ...
    try {
      final result = await services.initialize(
        ...
        transactionsFunction: () => widget.transactions.toJson(),
      );
      result.fold(
        (error) {
